...
$expectedPath = "data-plateform\transform-layer\data-ingestor"
...
if (-not $env:DBT_POSTGRES_PASSWORD) {
    Write-Warning "⚠️  DBT_POSTGRES_PASSWORD environment variable not set"
    Write-Warning "Using default password 'postgres'. Set the environment variable for production."
    $env:DBT_POSTGRES_PASSWORD = "postgres"
}
