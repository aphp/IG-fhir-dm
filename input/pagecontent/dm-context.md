L'entrepôt de Données de Santé de l'AP-HP est un dépôt central de données standardisées provenant de sources multiples au sein de l'AP-HP. Il est conçu pour :
