...
Description: """Représente la Fibroscopie oeso-gastroduodénale  dont a bénéficié [le patient 9](use-core-variables-acquisition.html#cas-9--ponction-évacuatrice-dascite)"""
Usage: #example
