...
* race_concept_id 1..1 Reference(OMOPConcept) "Race" "This field captures race or ethnic background of the person."
* ethnicity_concept_id 1..1 Reference(OMOPConcept) "Ethnicity" "This field captures Ethnicity as defined by the Office of Management and Budget (OMB) of the US Government: it distinguishes only between “Hispanic” and “Not Hispanic”. Races and ethnic backgrounds are not stored here."
* location_id 0..1 Reference(OMOPLocation) "Location" "The location refers to the physical address of the person. This field should capture the last known location of the person."
* provider_id 0..1 Reference(OMOPProvider) "Provider" "The Provider refers to the last known primary care provider (General Practitioner)."
* care_site_id 0..1 Reference(OMOPCareSite) "Care Site" "The Care Site refers to where the Provider typically provides the primary care."
...
* gender_source_concept_id 0..1 Reference(OMOPConcept) "Gender Source Concept" "If the source data codes biological sex in a non-standard vocabulary, store the concept_id here."
...
* race_source_concept_id 0..1 Reference(OMOPConcept) "Race Source Concept" "If the source data codes race in an OMOP supported vocabulary store the concept_id here."
...
* ethnicity_source_concept_id 0..1 Reference(OMOPConcept) "Ethnicity Source Concept" "If the source data codes ethnicity in an OMOP supported vocabulary, store the concept_id here."