...
* visit_detail_type_concept_id	1..1	Reference(OMOPConcept)	"Visit Detail Type" "Use this field to understand the provenance of the visit detail record, or where the record comes from."
...
* care_site_id	0..1	Reference(OMOPCareSite) "Care Site" "This field provides information about the Care Site where the Visit Detail took place."
...
* visit_detail_source_concept_id	0..1	Reference(OMOPConcept)	"Visit Detail Source Concept" ""
* admitted_from_concept_id	0..1	Reference(OMOPConcept)	"Admitted From" "Use this field to determine where the patient was admitted from. This concept is part of the visit domain and can indicate if a patient was admitted to the hospital from a long-term care facility, for example."
...
* discharged_to_concept_id	0..1	Reference(OMOPConcept)	"Discharged To" "Use this field to determine where the patient was discharged to after a visit. This concept is part of the visit domain and can indicate if a patient was transferred to another hospital or sent to a long-term care facility, for example.  It is assumed that a person is discharged to home therefore there is not a standard concept id for \"home\".  Use concept id = 0 when a person is discharged to home."
* preceding_visit_detail_id	0..1	Reference(OMOPVisitDetail) "Preceding Visit" "Use this field to find the visit detail that occurred for the person prior to the given visit detail record. There could be a few days or a few years in between."
* parent_visit_detail_id	0..1	Reference(OMOPVisitDetail) "Parent Visit" "Use this field to find the visit detail that subsumes the given visit detail record. This is used in the case that a visit detail record needs to be nested beyond the VISIT_OCCURRENCE/VISIT_DETAIL relationship."
* visit_occurrence_id	1..1	Reference(OMOPVisitOccurrence) "Visit Occurrence" "Use this field to link the VISIT_DETAIL record to its VISIT_OCCURRENCE."