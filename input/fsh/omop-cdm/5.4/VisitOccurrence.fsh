...
* visit_type_concept_id	1..1	Reference(OMOPConcept)	"Visit Type" "Use this field to understand the provenance of the visit record, or where the record comes from."
* provider_id	0..1	Reference(OMOPProvider) "Provider" "There will only be one provider per visit record and the ETL document should clearly state how they were chosen (attending, admitting, etc.). If there are multiple providers associated with a visit in the source, this can be reflected in the event tables (CONDITION_OCCURRENCE, PROCEDURE_OCCURRENCE, etc.) or in the VISIT_DETAIL table."
* care_site_id	0..1	Reference(OMOPCareSite) "Care Site" "This field provides information about the Care Site where the Visit took place."
...
* visit_source_concept_id	0..1	Reference(OMOPConcept)	"Visit Source Concept" ""
* admitted_from_concept_id	0..1	Reference(OMOPConcept)	"Admitted From Concept" "Use this field to determine where the patient was admitted from. This concept is part of the visit domain and can indicate if a patient was admitted to the hospital from a long-term care facility, for example."
* admitted_from_source_value	0..1	string	"Admitted From Source Value" ""
* discharged_to_concept_id	0..1	Reference(OMOPConcept)	"Discharged To Concept" ""
* discharged_to_source_value	0..1	string	"Discharged To Source Value" ""
* preceding_visit_occurrence_id	0..1	Reference(OMOPVisitOccurrence) "Preceding Visit Occurrence"	"Use this field to find the visit that occurred for the person prior to the given visit. There could be a few days or a few years in between."