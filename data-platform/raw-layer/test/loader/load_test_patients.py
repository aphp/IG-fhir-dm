...
def main():
    ...
    logger.info(f"Using DB hostname: {connection_params['host']}")
    logger.info(f"Using DB port: {connection_params['port']}")
    logger.info(f"Using DB name: {connection_params['database']}")
