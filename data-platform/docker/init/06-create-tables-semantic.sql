...
\echo '🏗️ Création du schéma de tables SEMANTIC LAYER avec support français...'

-- Connexion à la base de données semantic_layer
\c semantic_layer
...
-- Définir le rôle actuel pour créer les tables avec le bon propriétaire
SET ROLE semantic_user;
...
\echo ''
\echo '✅ Création du schéma SEMANTIC LAYER terminée avec succès!'
